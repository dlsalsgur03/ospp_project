...
public class RankingFragment extends Fragment {
    ...
    private void initViews(View view) {
        ...
        cardRank1 = view.findViewById(R.id.cardRank1);
        cardRank2 = view.findViewById(R.id.cardRank2);
        cardRank3 = view.findViewById(R.id.cardRank3);

        tvTop1Rank = view.findViewById(R.id.tvTop1Rank);
        tvTop1Main = view.findViewById(R.id.tvTop1Main);
        tvTop1Sub = view.findViewById(R.id.tvTop1Sub);
        tvTop1Score = view.findViewById(R.id.tvTop1Score);

        tvTop2Rank = view.findViewById(R.id.tvTop2Rank);
        tvTop2Main = view.findViewById(R.id.tvTop2Main);
        tvTop2Sub = view.findViewById(R.id.tvTop2Sub);
        tvTop2Score = view.findViewById(R.id.tvTop2Score);

        tvTop3Rank = view.findViewById(R.id.tvTop3Rank);
        tvTop3Main = view.findViewById(R.id.tvTop3Main);
        tvTop3Sub = view.findViewById(R.id.tvTop3Sub);
        tvTop3Score = view.findViewById(R.id.tvTop3Score);
    }
